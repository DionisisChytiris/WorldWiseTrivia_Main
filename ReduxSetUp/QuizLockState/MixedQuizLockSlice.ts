...
// AsyncStorage Key
const STORAGE_KEY = "quizLockStateMixed";
...
const quizLockMixedSlice = createSlice({
  name: "quizLockMixed",
  initialState,
  reducers: {
    setQuizLockMixed: (state, action: PayloadAction<{ id: string; locked: boolean }>) => {
...
export const { setQuizLockMixed, clearQuizLockMixedState } = quizLockMixedSlice.actions;
export default quizLockMixedSlice.reducer;
