...
// AsyncStorage Key
const STORAGE_KEY = "quizLockStateCapitals";
...
const quizLockSlice = createSlice({
  name: "quizLockCapitals",
  initialState,
  reducers: {
    setQuizLock: (state, action: PayloadAction<{ id: string; locked: boolean }>) => {
...
export const { setQuizLock, clearQuizLockState } = quizLockSlice.actions;
