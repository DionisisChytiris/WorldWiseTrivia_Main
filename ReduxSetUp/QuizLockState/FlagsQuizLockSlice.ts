...
// AsyncStorage Key
const STORAGE_KEY = "quizLockStateFlags";
...
const quizLockFlagsSlice = createSlice({
  name: "quizLockFlags",
  initialState,
  reducers: {
    setQuizLockFlags: (state, action: PayloadAction<{ id: string; locked: boolean }>) => {
...
export const { setQuizLockFlags, clearQuizLockFlagsState } = quizLockFlagsSlice.actions;
export default quizLockFlagsSlice.reducer;
