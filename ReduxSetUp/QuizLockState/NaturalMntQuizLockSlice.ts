...
// AsyncStorage Key
const STORAGE_KEY = "quizLockStateNaturalMnt";
...
const quizLockNaturalMntSlice = createSlice({
  name: "quizLockNaturalMnt",
  initialState,
  reducers: {
    setQuizLockNaturalMnt: (state, action: PayloadAction<{ id: string; locked: boolean }>) => {
    ...
    clearQuizLockNaturalMntState: (state) => {
...
export const { setQuizLockNaturalMnt, clearQuizLockNaturalMntState } = quizLockNaturalMntSlice.actions;
export default quizLockNaturalMntSlice.reducer;
