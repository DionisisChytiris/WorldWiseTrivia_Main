const questions4El = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "2",
        capital: 'Ανάκτορα του Μπάκιγχαμ',
        country: 'Ηνωμένο Βασίλειο'
      },
      {
        id: "3",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "2",
        capital: 'Μνημείο Ειρήνης της Χιροσίμα',
        country: 'Ιαπωνία'
      },
      {
        id: "3",
  ...
  },
  {
    id: "8b",
    status: "Flags",
    country: "Μνημείο Ειρήνης της Χιροσίμα",
    capital: "Ιαπωνία",
    options: [
      {
        id: "0",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "1",
        capital: 'Εμπάιρ Στέιτ Μπίλντινγκ',
        country: 'ΗΠΑ'
      },
      {
        id: "2",
