const questions2El = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "3",
        capital: "Αβαείο του Ουεστμίνστερ",
        country: "Ηνωμένο Βασίλειο",
      },
    ],
    correctAnswerIndex: 2,
  },
  {
    ...
    options: [
      {
        id: "0",
        country: "Καθεδρικός Ναός του Μιλάνου\nIταλία",
  ...
  },
  {
    ...
    options: [
      {
        id: "0",
        capital: "Μνημείο του Λίνκολν",
        country: "ΗΠΑ",
      },
      {
        id: "1",
        capital: "Λευκός Οίκος",
        country: "ΗΠΑ",
      },
      {
        id: "2",
      ...
      {
        id: "3",
        capital: "Καπιτώλιο των Ηνωμένων Πολιτειών",
        country: "ΗΠΑ",
      },
    ],
    correctAnswerIndex: 3,
  },
  {
    id: "5b",
    status: "Flags",
    country: "Καπιτώλιο των Ηνωμένων Πολιτειών",
    capital: "HΠΑ",
    options: [
      {
        id: "0",
  ...
  },
  {
    ...
    capital: "Ηνωμένα Αραβικά Εμιράτα",
    options: [
      {
        id: "0",
        country: "Μνημείο του Ουάσινγκτον\nΗΠΑ",
  ...
  },
  {
    ...
    options: [
      {
        id: "0",
        capital: "Βασιλική του\nΑγίου Πέτρου",
        country: "Βατικανό",
      },
      {
        id: "1",
        capital: "Ξύλινη εκκλησία\nΒόργουντ",
        country: "Nορβηγία",
      },
      {
        id: "2",
