const questions9Es = [
    {
      ...
      {
        id: "3",
        monument: "Mexico City Cathedral",
        country: "Mexico",
        options: [
          {
            id: "0",
      ...
      {
        id: "4",
        monument: "Saint Joseph's Oratory",
        country: "Canada",
        options: [
          {
            id: "0",
